...
$\ast$~a.r.mccluskey@bath.ac.uk; tom.arnold@esss.se}
...
It should be noted that these inverse uncertainties account only for the uncertainty in the analysis process and do not consider systematic uncertainties present, and unaccounted for, in the reflectometry measurement.
