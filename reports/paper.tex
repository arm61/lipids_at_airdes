...
\begin{table}
  ...
  $\phi_h$ were obtained from the appropriate use of Eqn. \ref{equ:phih} \cite{SI2018}.}
  \begin{ruledtabular}
	\begin{tabular}{ccccc}
...
other techniques (compare Tables \ref{tab:water} and \ref{tab:liptab}) \cite{SI2018}.
...
(Table \ref{tab:water}) \cite{SI2018}.
