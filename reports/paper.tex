...
Furthermore, this is one of the very few examples of a phospholipid monolayer at the interface between air and a non-aqueous solvent, with only formamide previously \cite{graner_phospholipidic_1995}.
...
In these works, the authors noted that the non-aqueous had an effect on the overall structure of the monolayer, however, little was noted about the underlying mechanism.
...
In this work, we present the first investigation of the structure of phospholipid monolayers at the air-DES interface, as determined by chemically-consistent modelling of X-ray reflectometry (XRR) measurements at multiple surface pressures.
Four different phospholipids; 1,2-dipalmitoyl-sn-glycero-3-phosphocholine (DPPC), 1,2-dimyristoyl-sn-glycero-3-phosphocholine (DMPC),  1,2-dilauroyl-sn-glycero-3-phosphocholine (DLPC) and 1,2-dimyristoyl-sn-glycero-3-phospho-(1'-rac-glycerol) (DMPG), were studied at the interface between a 1:2 mixture of choline chloride:glycerol and air.
This allowed the nature of two, chemically distinct, phospholipid head components to be understood in this ionic solvent, in addition to the effect of the tail chain length.
The analysis was then extended to model complementary neutron reflectometry measurements for two contrasts of DMPC and DPPC at a single surface pressure [This paragraph was added following the comments of Ref 3].
...
It can be observed that as the surface pressure increases, the thickness of the tail layer also increases, this rate of increase appears reduces for DPPC and DMPC at higher surface pressure indicating a maximum value is being reached [Sentence changed to reflect Ref 1 comments].
...
The major difference between the two head components is the fact that the PG component is present as a sodium salt, whereas the PC component is zwitterionic.
The solvation of the PG salt occurs in the choline chloride:glycerol DES with a high degree of dissociation, whereas the zwitterionic PC salt is less soluble \cite{sanchez-fernandez_self-assembly_2018}.
This will lead to the PG head component solvation sphere consisting of the larger, by comparison to water, DES molecules contributed to the apparent head component volume increase.
Additionally, the charged nature of the PG head component following solvation may result in the electrostatic binding of the choline counterion from the DES, such preferential binding has been observed previously in the self-assembly of surfactant micelles \cite{sanchez-fernandez_counterion_2018}.
The choline molecule offers a larger counterion than the sodium that is replaced, further contributing to the apparent head component volume increase [This paragraph has been adapted significantly following comments from Ref 1].
