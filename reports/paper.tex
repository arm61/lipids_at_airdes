...
Furthermore, this is one of very few examples of a phospholipid monolayer at the interface between air and a non-aqueous solvent, with only formamide and mercury being noted previously \cite{Weinbach1993,Graner1995, Magnussen1996, Kraack2002}.
...
However, as this has only been shown for a single PG-lipid at the air-DES interface, the results are not conclusive.
