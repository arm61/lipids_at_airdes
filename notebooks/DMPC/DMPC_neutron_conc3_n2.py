...
dataset3_n2 = ReflectDataset('{}DMPC_Neutron_conc1_dDMPC_hdDES.mft'.format(data_dir))
...
dmpc3_n2 = mv.VolMono(head_sl[1], thick_heads[1], tail_sl[1], tail_length, chain_tilt[1], vols, 
                  head_tail_rough, tail_air_rough, reverse_monolayer=True, name='dmpc3_n2')
...
structure_dmpc3_n2 = air(0, 0) | dmpc3_n2 | des_n2(0, 0)
...
dmpc3_n2.solventrough.setp(get_value('rough4'), vary=True, bounds=(2.0, 12.))
dmpc3_n2.phih.constraint = 1 - (dmpc3_n2.head_mol_vol * dmpc3_n2.tail_length * dmpc3_n2.cos_rad_chain_tilt / (dmpc3_n2.tail_mol_vol * dmpc3_n2.thick_heads))
...
dmpc3_n2.phit.setp(0, vary=False)
...
model_dmpc3_n2 = ReflectModel(structure_dmpc3_n2)
model_dmpc3_n2.scale.setp(0.9364, vary=True, bounds=(0.005, 100))
# The background for held constant to a value determined from a previous fitting
model_dmpc3_n2.bkg.setp(dataset3_n2.y[-1], vary=False)
...
objective_n2 = Objective(model_dmpc3_n2, dataset3_n2, transform=Transform('YX4'))
...
res = fitter.sample(1000, nthin=1, random_state=2, f='{}dmpc_highconc_chain_neutron_n2.txt'.format(analysis_dir))
...
printref("3_n2", dataset3_n2, model_dmpc3_n2, objective_n2, analysis_dir, choose)
printsld("3_n2", structure_dmpc3_n2, objective_n2, choose)
...
lab2 = ['solh3']
kl = 1 - ((dmpc3_n2.head_mol_vol.value * flatchain[:, 1] * dmpc3_n2.tail_length.value) / (dmpc3_n2.tail_mol_vol.value * dmpc3_n2.thick_heads.value))
kl = kl * 100
