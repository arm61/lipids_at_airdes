...
dppc3_n2.tail_mol_vol.setp(891., vary=False)
dppc3_n2.tail_length.setp(vary=False)
dppc3_n2.cos_rad_chain_tilt.setp(get_value('angle5'), vary=True, bounds=(0.1, 0.9))
dppc3_n2.rough_head_tail.setp(get_value('roughh5'), vary=False, bounds=(0.1, 20))
dppc3_n2.rough_preceding_mono.setp(get_value('rought5'), vary=True, bounds=(0.1,12))
dppc3_n2.phit.setp(get_value('solt5')/100, vary=True, bounds=(0, 0.6))
dppc3_n2.phih.setp(get_value('solh5')/100, vary=True, bounds=(0, 0.9999))
...
dppc3_n2.thick_heads.setp(get_value('head5'), vary=False)
dppc3_n2.cos_rad_chain_tilt.constraint = (dppc3_n2.tail_mol_vol * (1 - dppc3_n2.phih) * dppc3_n2.thick_heads) / (dppc3_n2.head_mol_vol * dppc3_n2.tail_length * (1 - dppc3_n2.phit))
...
a = (dppc3_n2.tail_mol_vol.value * (1 - flatchain[:, 3]) * dppc3_n2.thick_heads.value) 
b = (dppc3_n2.head_mol_vol.value * dppc3_n2.tail_length.value * (1 - flatchain[:, 2]))
angle3 = a / b
