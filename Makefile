...
DLPC_OUT = output/dlpc4_ref.txt output/dlpc4_sld.txt output/dlpc5_ref.txt output/dlpc5_sld.txt output/dlpc_highconc_chain.txt $(DLPC_DIR)/angle4.txt $(DLPC_DIR)/angle5.txt $(DLPC_DIR)/head4.txt $(DLPC_DIR)/head5.txt $(DLPC_DIR)/roughh4.txt $(DLPC_DIR)/roughh5.txt $(DLPC_DIR)/rought4.txt $(DLPC_DIR)/rought5.txt $(DLPC_DIR)/scale4.txt $(DLPC_DIR)/scale5.txt $(DLPC_DIR)/solh4.txt $(DLPC_DIR)/solh5.txt $(DLPC_DIR)/solt4.txt $(DLPC_DIR)/solt5.txt $(DLPC_DIR)/tail4.txt $(DLPC_DIR)/tail5.txt $(DLPC_DIR)/vh.txt
DMPC_OUT = output/dmpc4_ref.txt output/dmpc4_sld.txt output/dmpc5_ref.txt output/dmpc5_sld.txt output/dmpc_highconc_chain.txt $(DMPC_DIR)/angle4.txt $(DMPC_DIR)/angle5.txt $(DMPC_DIR)/head4.txt $(DMPC_DIR)/head5.txt $(DMPC_DIR)/roughh4.txt $(DMPC_DIR)/roughh5.txt $(DMPC_DIR)/rought4.txt $(DMPC_DIR)/rought5.txt $(DMPC_DIR)/scale4.txt $(DMPC_DIR)/scale5.txt $(DMPC_DIR)/solh4.txt $(DMPC_DIR)/solh5.txt $(DMPC_DIR)/solt4.txt $(DMPC_DIR)/solt5.txt $(DMPC_DIR)/tail4.txt $(DMPC_DIR)/tail5.txt $(DMPC_DIR)/vh.txt
DPPC_OUT = output/dppc4_ref.txt output/dppc4_sld.txt output/dppc5_ref.txt output/dppc5_sld.txt output/dppc_highconc_chain.txt $(DPPC_DIR)/angle4.txt $(DPPC_DIR)/angle5.txt $(DPPC_DIR)/head4.txt $(DPPC_DIR)/head5.txt $(DPPC_DIR)/roughh4.txt $(DPPC_DIR)/roughh5.txt $(DPPC_DIR)/rought4.txt $(DPPC_DIR)/rought5.txt $(DPPC_DIR)/scale4.txt $(DPPC_DIR)/scale5.txt $(DPPC_DIR)/solh4.txt $(DPPC_DIR)/solh5.txt $(DPPC_DIR)/solt4.txt $(DPPC_DIR)/solt5.txt $(DPPC_DIR)/tail4.txt $(DPPC_DIR)/tail5.txt $(DPPC_DIR)/vh.txt
DMPG_OUT = output/dmpg4_ref.txt output/dmpg4_sld.txt output/dmpg5_ref.txt output/dmpg5_sld.txt output/dmpg_highconc_chain.txt $(DMPG_DIR)/angle4.txt $(DMPG_DIR)/angle5.txt $(DMPG_DIR)/head4.txt $(DMPG_DIR)/head5.txt $(DMPG_DIR)/roughh4.txt $(DMPG_DIR)/roughh5.txt $(DMPG_DIR)/rought4.txt $(DMPG_DIR)/rought5.txt $(DMPG_DIR)/scale4.txt $(DMPG_DIR)/scale5.txt $(DMPG_DIR)/solh4.txt $(DMPG_DIR)/solh5.txt $(DMPG_DIR)/solt4.txt $(DMPG_DIR)/solt5.txt $(DMPG_DIR)/tail4.txt $(DMPG_DIR)/tail5.txt $(DMPG_DIR)/vh.txt
NDMPC1_OUT = output/dmpc3_n1_ref_neutron.txt output/dmpc3_n1_sld_neutron.txt output/dmpc_highconc_chain_neutron_n1.txt $(DMPC_DIR)/angle3_neutron_n1.txt $(DMPC_DIR)/rought3_neutron_n1.txt $(DMPC_DIR)/scale3_neutron_n1.txt $(DMPC_DIR)/solh3_neutron_n1.txt $(DMPC_DIR)/solt3_neutron_n1.txt $(DMPC_DIR)/tail3_neutron_n1.txt
NDMPC2_OUT = output/dmpc3_n2_ref_neutron.txt output/dmpc3_n2_sld_neutron.txt output/dmpc_highconc_chain_neutron_n2.txt $(DMPC_DIR)/angle3_neutron_n2.txt $(DMPC_DIR)/rought3_neutron_n2.txt $(DMPC_DIR)/scale3_neutron_n2.txt $(DMPC_DIR)/solh3_neutron_n2.txt $(DMPC_DIR)/solt3_neutron_n2.txt $(DMPC_DIR)/tail3_neutron_n2.txt
NDPPC1_OUT = output/dppc3_n1_ref_neutron.txt output/dppc3_n1_sld_neutron.txt output/dppc_highconc_chain_neutron_n1.txt $(DPPC_DIR)/angle3_neutron_n1.txt $(DPPC_DIR)/rought3_neutron_n1.txt $(DPPC_DIR)/scale3_neutron_n1.txt $(DPPC_DIR)/solh3_neutron_n1.txt $(DPPC_DIR)/solt3_neutron_n1.txt $(DPPC_DIR)/tail3_neutron_n1.txt
NDPPC2_OUT = output/dppc3_n2_ref_neutron.txt output/dppc3_n2_sld_neutron.txt output/dppc_highconc_chain_neutron_n2.txt $(DPPC_DIR)/angle3_neutron_n2.txt $(DPPC_DIR)/rought3_neutron_n2.txt $(DPPC_DIR)/scale3_neutron_n2.txt $(DPPC_DIR)/solh3_neutron_n2.txt $(DPPC_DIR)/solt3_neutron_n2.txt $(DPPC_DIR)/tail3_neutron_n2.txt
